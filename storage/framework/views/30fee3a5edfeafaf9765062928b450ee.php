...
<div class="card">
    <div class="card-body">
        <h1 class="display-1 text-primary my-5">Search Students By Phone</h1>
        <form class="row mb-4" action="/students/search-by-phone" method="get">
            <div class="col-10">
                <input type="text" name="phone" id="phone" value="<?php echo e(request('phone')); ?>" class="form-control" placeholder="Type a Phone Number Here">
            </div>
            <div class="col-2">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mahmoud Emara\Desktop\LearnPlus\resources\views/students/search-by-phone.blade.php ENDPATH**/ ?>